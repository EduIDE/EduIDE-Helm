...
| gateway.redirects | list | `[]` | Permanent redirects from hostnames this cluster used to serve. Each needs a listener of the same name; renders an HTTPRoute that 301s `from` to `to`, keeping path and query. |
